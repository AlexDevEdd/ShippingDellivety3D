...
namespace MoreMountains.NiceVibrations
{
    ...
    public static class MMVibrationManager
    {
        ...
        public static bool HaveTaptic()
        {
            bool _have = true;
            if (SystemInfo.deviceModel == "iPhone5,1" || SystemInfo.deviceModel == "iPhone5,2" || SystemInfo.deviceModel == "iPhone5,3" ||
                SystemInfo.deviceModel == "iPhone5,4" || SystemInfo.deviceModel == "iPhone6,1" || SystemInfo.deviceModel == "iPhone6,2" ||
                SystemInfo.deviceModel == "iPhone7,2" || SystemInfo.deviceModel == "iPhone7,1")
                _have = false;
            return _have;
        }
        ...
        public static void Haptic(HapticTypes type, bool _needTaptic = false)
        {
            if (MainData.Instance.isVibration)
            {
                if (Android())
                {
                    switch (type)
